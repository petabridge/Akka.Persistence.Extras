...
using Delivery = Akka.Persistence.AtLeastOnceDeliverySemantic.Delivery;
using RedeliveryTick = Akka.Persistence.AtLeastOnceDeliverySemantic.RedeliveryTick;

namespace Akka.AtLeastOnceDeliveryJournaling
{
    /// <summary>
    ...
    public class IncrementalAtLeastOnceDeliverySemantic
    {
        ...
        public IncrementalAtLeastOnceDeliverySemantic(IActorContext context, PersistenceSettings.AtLeastOnceDeliverySettings settings)
        {
            _context = context;
            _settings = settings;
